...
app.post("/print", async (req, res) => {
  try {
    ...
    if (parrilla.length > 0) {
      ...
      if (esParaLlevar) {
        // Para "para llevar" con brasas, usar generarTicketDelivery en AMBAS impresoras
        // para que sean exactamente iguales
        ticketParrilla = generarTicketDelivery({
        ...
        ticketParrilla = generarTicketCocina({
          mesa,
          productos: parrilla,
          orden,
          hora,
      ...
      // Si es para llevar, las brasas van a AMBAS impresoras con el MISMO ticket
      if (esParaLlevar) {
        // Enviar el MISMO ticket a COCINA (para que sean idénticos)
