...
# Configuración
REPO_URL="https://github.com/francoluca35/impresora-local.git"
...
cd "$INSTALL_DIR/impresora-local"
...
Type=forking
User=$SERVICE_USER
WorkingDirectory=$INSTALL_DIR/impresora-local
